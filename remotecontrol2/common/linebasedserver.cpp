...
boost::asio::awaitable<void> LineBasedServer::handle_connection(boost::asio::ip::tcp::socket sock)
{
    ...
    co_await (
        ...
        // When either of the echo() or watchdog() coroutines exit, the io-operations in the other function will fail with
        ...
        // extended by echo() each time it receives a message.
        ||  
